...
public static class ScreenshotCamera
{
    /// <summary>
    /// </summary>
    ...
    public static Texture2D CaptureScreen(int lw = 0, int lh = 0, int limitSize = 0)
    {
        ...
        if (lw != 0)// 758,568
        {
            ...
            screenshot.ReadPixels(new Rect(0, Screen.height - lh, width, Screen.height), 0, 0);
        }
        else
